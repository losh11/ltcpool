...
const portalConfigFile = require('./config.json');
const poolConfigFile = require('./pool_configs/litecoin.json')
...
var portalConfig = JSON.parse(JSON.stringify(portalConfigFile));
var poolConfigs;
...
var buildPoolConfigs = function(){
    ...
    fs.readdirSync(configDir).forEach(function(file){
        var poolOptions = JSON.parse(JSON.stringify(poolConfigFile));
